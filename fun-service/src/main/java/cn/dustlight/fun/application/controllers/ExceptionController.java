...
import cn.dustlight.fun.core.exceptions.ErrorDetails;
import cn.dustlight.fun.core.exceptions.ErrorEnum;
import cn.dustlight.fun.core.exceptions.FunException;
...
public class ExceptionController {
    ...
    public Mono<ErrorDetails>  onErrorException(FunException e,ServerWebExchange exchange) {
        var response = exchange.getResponse();
        var request = exchange.getRequest() ;
